  ...
  \centerline{\bf Chapter 16}
    ...
    \item Find a parametrization from the region $G$ to the surface $S$. (16.6)
      ...
      \begin{enumerate}
        ...
        \item $G:$ $0\leq\theta\leq \frac{\pi}{2}$ and $1\leq r\leq 2$\\ $S:$ the portion of the conical surface $z=\sqrt{x^2+y^2}$ within the first octant and between the planes $z=1$ and $z=2$
        \item $G:$ $0\leq\theta\leq 2\pi$ and $0\leq \rho\leq 3$\\ $S:$ the portion of the conical surface $z=\sqrt{x^2+y^2}$ inside the sphere $x^2+y^2+z^2=9$
      \end{enumerate}

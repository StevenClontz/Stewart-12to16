...
\centerline{\bf Chapter 15}
  ...
  \centerline{\bf Chapter 16}
    ...
    \item Find a parametrization from the region $G$ to the surface $S$. (16.6)
      ...
      \begin{enumerate}
        \item $G:$ $0\leq x\leq 2$ and $0\leq y\leq 1$\\ $S:$ the portion of the elliptical paraboloid $z=x^2+y^2$ above $G$
        \item $G:$ triangle with vertices $(0,0)$, $(2,0)$, $(2,4)$\\ $S:$ the triangle with vertices $(0,0,8)$, $(2,0,6)$, $(2,4,2)$
        \item $G:$ $0\leq\theta\leq 2\pi$ and $-1\leq z\leq 4$\\ $S:$ the lateral surface on the cylinder $x^2+y^2=9$ between $z=-1$ and $z=4$
        \item $G:$ $0\leq\theta\leq 2\pi$ and $0\leq\phi\leq\pi$\\  $S:$ the sphere $x^2+y^2+z^2=4$
        \item $G:$ $0\leq\theta\leq \frac{\pi}{2}$ and $1\leq r\leq 2$\\ $S:$ the conical surface $z=\sqrt{x^2+y^2}$ within the first octant and between the planes $z=1$ and $z=2$
        \item $G:$ $0\leq\theta\leq \frac{\pi}{2}$ and $\sqrt{2}\leq \rho\leq 2\sqrt{2}$\\ $S:$ the conical surface along $z=\sqrt{x^2+y^2}$ in the first octant and between the planes $z=1$ and $z=2$
      \end{enumerate}

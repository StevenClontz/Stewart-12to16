...
\lhead{}
\chead{Stewart's Calculus Chapter 12-16 Notes}
\rhead{Page \thepage}
...
% %%%%%%%%%%
% % IMAGES % TODO: get these working
% %%%%%%%%%%
% % Generated with LaTeXDraw 2.0.8
% % Wed May 15 14:38:09 CDT 2013
% \usepackage[usenames,dvipsnames]{pstricks}
% % \usepackage{epsfig}
% % \usepackage{pst-grad} % For gradients
% % \usepackage{pst-plot} % For axes
% \newcommand{\figChainRule}{
%   \scalebox{1} { % Change this value to rescale the drawing.
%     \begin{pspicture}(0,-0.8972656)(4.5931444,0.8972656)
%       \usefont{T1}{ptm}{m}{n}
%       \rput(2.2477636,0.71265626){f}
%       \psline[linewidth=0.04cm](2.2564843,0.52765626)(0.65648437,0.12765625)
%       \psline[linewidth=0.04cm](2.2564843,0.52765626)(2.2564843,0.12765625)
%       \psline[linewidth=0.04cm](2.2564843,0.52765626)(3.8564844,0.12765625)
%       \psline[linewidth=0.04cm](0.65648437,-0.27234375)(0.056484375,-0.47234374)
%       \psline[linewidth=0.04cm](0.65648437,-0.27234375)(0.65648437,-0.47234374)
%       \psline[linewidth=0.04cm](0.65648437,-0.27234375)(1.2564844,-0.47234374)
%       \psline[linewidth=0.04cm](2.2564843,-0.27234375)(1.6564844,-0.47234374)
%       \psline[linewidth=0.04cm](2.2564843,-0.27234375)(2.2564843,-0.47234374)
%       \psline[linewidth=0.04cm](2.2564843,-0.27234375)(2.8564844,-0.47234374)
%       \psline[linewidth=0.04cm](3.8564844,-0.27234375)(3.2564843,-0.47234374)
%       \psline[linewidth=0.04cm](3.8564844,-0.27234375)(3.8564844,-0.47234374)
%       \psline[linewidth=0.04cm](3.8564844,-0.27234375)(4.4564843,-0.47234374)
%       \usefont{T1}{ptm}{m}{n}
%       \rput(0.66191405,-0.06734375){x}
%       \usefont{T1}{ptm}{m}{n}
%       \rput(2.264375,-0.04734375){y}
%       \usefont{T1}{ptm}{m}{n}
%       \rput(3.849873,-0.06734375){z}
%       \usefont{T1}{ptm}{m}{n}
%       \rput(0.045,-0.72734374){t}
%       \usefont{T1}{ptm}{m}{n}
%       \rput(0.6460449,-0.72734374){u}
%       \usefont{T1}{ptm}{m}{n}
%       \rput(1.2433203,-0.7473438){v}
%       \usefont{T1}{ptm}{m}{n}
%       \rput(1.665,-0.70734376){t}
%       \usefont{T1}{ptm}{m}{n}
%       \rput(2.2660449,-0.70734376){u}
%       \usefont{T1}{ptm}{m}{n}
%       \rput(2.8633204,-0.72734374){v}
%       \usefont{T1}{ptm}{m}{n}
%       \rput(3.265,-0.72734374){t}
%       \usefont{T1}{ptm}{m}{n}
%       \rput(3.866045,-0.72734374){u}
%       \usefont{T1}{ptm}{m}{n}
%       \rput(4.4633203,-0.7473438){v}
%     \end{pspicture} 
%   }
% }
